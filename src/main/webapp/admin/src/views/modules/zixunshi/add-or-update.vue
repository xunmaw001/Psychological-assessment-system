        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.zixunshiContent"  label="咨询师详细介绍" prop="zixunshiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.zixunshiContent" label="咨询师详细介绍" prop="zixunshiContent">
