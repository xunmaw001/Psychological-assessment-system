                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            <!--                          {{scope.row.totalScore}}
                                                      ...
                                                      <td v-if="item.totalScore>=80">心理健康</td>
                                                      <td v-else-if="item.totalScore>=60">心理一般</td>
                                                      <td v-else>心理很差</td>-->
                            <span v-if="scope.row.totalScore>=80">心理健康</span>
                            <span v-else-if="scope.row.totalScore>=60">心理一般</span>
                            <span v-else>心理很差</span>
                        </template>
                    </el-table-column>
